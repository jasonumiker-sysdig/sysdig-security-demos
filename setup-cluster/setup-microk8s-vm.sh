...
multipass launch --cpus 4 --mem 8G --disk 20G --name microk8s-vm 22.04

# Deploy and run setup-microk8s.sh to our new VM
multipass transfer ./bootstrap-microk8s-vm.sh microk8s-vm:/home/ubuntu/
multipass transfer ./sysdig-agent-helm-install.sh microk8s-vm:/home/ubuntu/
multipass exec microk8s-vm -- chmod +x /home/ubuntu/bootstrap-microk8s-vm.sh
multipass exec microk8s-vm -- chmod +x /home/ubuntu/sysdig-agent-helm-install.sh
